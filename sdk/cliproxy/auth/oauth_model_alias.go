...
//
// Supported channels: gemini-cli, vertex, aistudio, antigravity, claude, codex, qwen, iflow, kimi, kiro, github-copilot.
func OAuthModelAliasChannel(provider, authKind string) string {
	...
	case "codex":
		...
		return "codex"
	case "gemini-cli", "aistudio", "antigravity", "qwen", "iflow", "kimi", "kiro", "github-copilot":
		return provider
	default:
		return ""
	}
